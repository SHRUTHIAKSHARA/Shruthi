        ...
        <MDBCol col='6' className="mb-5">
          <div className="d-flex flex-column ms-5">
            ...
            <div className="text-center">
              <img src="https://media.istockphoto.com/id/1415003566/photo/stethoscope-syringe-purple-heart-and-check-list-under-yellow-umbrella.jpg?s=612x612&w=0&k=20&c=D5RafShGWk_grIFFI0M-D0zmOAPvZVDliZ8I-37_8Yg="
            ...
            <div className="d-flex flex-row align-items-center justify-content-center pb-4 mb-4">
              ...
              <MDBBtn outline className='mx-2' color='info' onClick={handlesign}>
                Create Account
              </MDBBtn>
            </div>
