      ...
      <MDBRow className='justify-content-center align-items-center m-5'>
        ...
        <MDBCard>
          <MDBCardBody className='px-4 ccc'>
            ...
            <h3 className="fw-bold mb-4 pb-2 pb-md-0 mb-md-5" style={{color:'white'}}>Registration Form</h3>
            ...
            {/* <MDBSelect
              ...
              />*/}
            <MDBBtn className='mb-4' size='lg' style={{ backgroundColor: 'white', color:'#6f42c1' }} onClick={handlesub}>Submit</MDBBtn>
